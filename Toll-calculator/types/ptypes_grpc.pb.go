...
const (
	Aggregator_Aggregate_FullMethodName = "/types.Aggregator/Aggregate"
)
...
type AggregatorClient interface {
	Aggregate(ctx context.Context, in *AggregatorRequest, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *aggregatorClient) Aggregate(ctx context.Context, in *AggregatorRequest, opts ...grpc.CallOption) (*Empty, error) {
...
type AggregatorServer interface {
	Aggregate(context.Context, *AggregatorRequest) (*Empty, error)
...
func (UnimplementedAggregatorServer) Aggregate(context.Context, *AggregatorRequest) (*Empty, error) {
...
func _Aggregator_Aggregate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AggregatorServer).Aggregate(ctx, req.(*AggregatorRequest))
	}
